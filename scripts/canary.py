...
settings too, under 'plugin.admon'. That is the only way to canary a
plugin whose behavior is off by default::

    "options": {"plugin": {"admon": {"argument": true}}}

'extensions' names other mdformat plugins the repo's own docs build depends on
(e.g. 'mkdocs' for MkDocs admonitions), on top of the 'admon' this
